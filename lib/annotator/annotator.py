...
class Annotator:
    ...
    def __init__(self, img_w, img_h, model: str, ckpt: str, labels: str, classes: int):
        ...
        self.label_map = label_map_util.load_labelmap(labels)
    ...
    def annotate(self, img: np, session, detection_graph):
        ...
        (boxes, scores, classes, detections) = self.__annotate(session, boxes, scores, classes, detections, img_tensor, img_expanded)
    ...
    def __annotate(self, session, boxes, scores, classes, detections, img_tensor, img_expanded):
    ...
    def __crop(self, img: np, coords: tuple):
        ...
        img_crop = tf.image.crop_to_bounding_box(img, yminn, xminn, ymaxx - yminn, xmaxx - xminn)
